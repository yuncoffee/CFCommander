...
import { makeImage } from "./scripts/makeImage.js"
import {
    convertToVariableManager,
    readVariableJson,
} from "./scripts/readJson.js"
...
const NOTE_TEMPLATE = (name: string, date: string, count: number) => {
    return `---
slug: ${count}장
title: "#${count} ${name}"
...
const createNote = (name: string, date: string, count: number) => {
    makeDir(date, count)
